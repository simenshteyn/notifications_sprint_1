...
from models.message import (MessageCreate, MessageCreateCustom, MessageCustom,
                            MessageRead)
...
@router.post('/user', response_model=MessageRead,
...
@router.post('/custom', response_model=MessageCustom,
             response_model_exclude_unset=True)
async def render_custom_message(
        message: MessageCreateCustom,
        message_service: MessageService = Depends(get_message_service)
) -> MessageCustom:
